...
def count_symbols(some_string):
    return {symb: some_string.count(symb) for symb in set(some_string)}

print('even:', even(not_even_list))
print('get_ages', get_ages(years_of_birth))
print('get_first_n_last', get_first_n_last(numbers))
print('get_list_without_repetition', get_list_without_repetition(list_with_repetition))
print('map_keys_and_values', map_keys_and_values(keys, values))
print('count_symbols', count_symbols(s))